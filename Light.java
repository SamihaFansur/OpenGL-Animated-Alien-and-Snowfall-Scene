...
public class Light {
  ...
  //Added light direction to class because spotlight uses it
  private final Vec3 lightDirection = new Vec3(0, 0, 0);
  //Added intensity variable for light(on/off)
  ...
  //Added intensity setter to turn light on/off
  public void setLightIntensity(float i){
    this.lightIntensity = i;
  }
  //Added intensity getter to turn light on/off
  public float getLightIntensity(){
   return lightIntensity;
  }

  //Added new light direction setter
  ...
  //Added new light direction getter
